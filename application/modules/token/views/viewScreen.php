                ...
                $.ajax({
                    ...
                    beforeSend: function () {
                        ...
                        if (res.status) {
                            ...
                            var mywindow = window.open('', 'Choithram Hospital Indore', 'height=400,width=600');
                            mywindow.document.write('<html><head><title>Choithram Hospital Indore</title>');
