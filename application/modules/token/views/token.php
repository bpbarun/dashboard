                ...
                <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6 col-12 col-sm-6">
                            <div class="blogThumb">
                                <div class="thumb-center"><img class="img-responsive" alt="user" src="<?php echo base_url();?>assets/img/course/course1.jpg"></div>
                        ...
                        <div class="col-lg-3 col-md-6 col-12 col-sm-6">
                            <div class="blogThumb">
                                <div class="thumb-center"><img class="img-responsive" alt="user" src="<?php echo base_url();?>assets/img/course/course2.jpg"></div>
                                <div class="course-box">
                                    <h4>PHP Development Course</h4>
                                    <div class="text-muted"><span class="m-r-10">April 23</span>
                                        <a class="course-likes m-l-10" href="#"><i class="fa fa-heart-o"></i> 654</a>
                        ...
                        <div class="col-lg-3 col-md-6 col-12 col-sm-6">
                            <div class="blogThumb">
                                <div class="thumb-center"><img class="img-responsive" alt="user" src="<?php echo base_url();?>assets/img/course/course3.jpg"></div>
                                <div class="course-box">
                                    <h4>PHP Development Course</h4>
                                    <div class="text-muted"><span class="m-r-10">April 23</span>
                                        <a class="course-likes m-l-10" href="#"><i class="fa fa-heart-o"></i> 654</a>
                        ...
                        <div class="col-lg-3 col-md-6 col-12 col-sm-6">
                            <div class="blogThumb">
                                <div class="thumb-center"><img class="img-responsive" alt="user" src="<?php echo base_url();?>assets/img/course/course4.jpg"></div>
                                <div class="course-box">
                                    <h4>PHP Development Course</h4>
                                    <div class="text-muted"><span class="m-r-10">April 23</span>
                                        <a class="course-likes m-l-10" href="#"><i class="fa fa-heart-o"></i> 654</a>
                                        ...
                                        <div class="compose-mail">
                                            <form method="post">
                                                ...
                                                <div class="box-footer clearfix">
                                                    <button type="button" class="mdl-button mdl-button--raised mdl-js-ripple-effect m-b-10 btn-primary pull-right">Send
                                    ...
                                    <ul class="feedBody">
                                        <li class="active-feed">
                                            <div class="feed-user-img">
                                                <img src="<?php echo base_url();?>assets/img/std/std1.jpg" class="img-radius " alt="User-Profile-Image">
                                            </div>
                                            <h6>
                                        ...
                                        <li class="diactive-feed">
                                            <div class="feed-user-img">
                                                <img src="<?php echo base_url();?>assets/img/std/std2.jpg" class="img-radius " alt="User-Profile-Image">
                                            </div>
                                            <h6>
                                        ...
                                        <li class="diactive-feed">
                                            <div class="feed-user-img">
                                                <img src="<?php echo base_url();?>assets/img/std/std3.jpg" class="img-radius " alt="User-Profile-Image">
                                            </div>
                                            <h6>
                                        ...
                                        <li class="active-feed">
                                            <div class="feed-user-img">
                                                <img src="<?php echo base_url();?>assets/img/std/std4.jpg" class="img-radius " alt="User-Profile-Image">
                                            </div>
                                            <h6>
                                        ...
                                        <li class="active-feed">
                                            <div class="feed-user-img">
                                                <img src="<?php echo base_url();?>assets/img/std/std5.jpg" class="img-radius " alt="User-Profile-Image">
                                            </div>
                                            <h6>
                                                <span class="feedLblStyle lblFileStyle">File</span> Sarah Smith <small class="text-muted">6 hours ago</small>
                                            </h6>
                                        ...
                                        <li class="diactive-feed">
                                            <div class="feed-user-img">
                                                <img src="<?php echo base_url();?>assets/img/std/std6.jpg" class="img-radius " alt="User-Profile-Image">
                                            </div>
                                            <h6>
                                                <span class="feedLblStyle lblTaskStyle">Task </span> Jalpa Joshi<small class="text-muted">5 hours
                                                    ago</small>
                            ...
                            <div class="chat-sidebar-list">
                                <div class="chat-sidebar-chat-users slimscroll-style" data-rail-color="#ddd" data-wrapper-class="chat-sidebar-list">
                                    ...
                                    <ul class="media-list list-items">
                                        <li class="media"><img class="media-object" src="<?php echo base_url();?>assets/img/prof/prof3.jpg" width="35" height="35" alt="...">
                                        ...
                                        <li class="media">
                                            ...
                                            </div> <img class="media-object" src="<?php echo base_url();?>assets/img/prof/prof1.jpg" width="35" height="35" alt="...">
                                            <i class="busy dot"></i>
                                            <div class="media-body">
                                        ...
                                        <li class="media"><img class="media-object" src="<?php echo base_url();?>assets/img/prof/prof5.jpg" width="35" height="35" alt="...">
                                            <i class="away dot"></i>
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            ...
                                            </div> <img class="media-object" src="<?php echo base_url();?>assets/img/prof/prof4.jpg" width="35" height="35" alt="...">
                                            <i class="online dot"></i>
                                            <div class="media-body">
                                        ...
                                        <li class="media"><img class="media-object" src="<?php echo base_url();?>assets/img/prof/prof2.jpg" width="35" height="35" alt="...">
                                            <i class="busy dot"></i>
                                            <div class="media-body">
                                        ...
                                        <li class="media"><img class="media-object" src="<?php echo base_url();?>assets/img/prof/prof7.jpg" width="35" height="35" alt="...">
                                            <i class="online dot"></i>
                                            <div class="media-body">
                                    ...
                                    <ul class="media-list list-items">
                                        <li class="media">
                                            ...
                                            </div> <img class="media-object" src="<?php echo base_url();?>assets/img/prof/prof6.jpg" width="35" height="35" alt="...">
                                        ...
                                        <li class="media"><img class="media-object" src="<?php echo base_url();?>assets/img/prof/prof8.jpg" width="35" height="35" alt="...">
                                            <i class="offline dot"></i>
                                            <div class="media-body">
                                        ...
                                        <li class="media">
                                            ...
                                            </div> <img class="media-object" src="<?php echo base_url();?>assets/img/prof/prof9.jpg" width="35" height="35" alt="...">
                                            <i class="offline dot"></i>
                                            <div class="media-body">
                                        ...
                                        <li class="media"><img class="media-object" src="<?php echo base_url();?>assets/img/prof/prof10.jpg" width="35" height="35" alt="...">
                                            <i class="offline dot"></i>
                                            <div class="media-body">
                            ...
                            <div class="chat-sidebar-item">
                                <div class="chat-sidebar-chat-user">
                                    ...
                                    <div class="chat-sidebar-chat-user-messages">
                                        <div class="post out">
                                            <img class="avatar" alt="" src="<?php echo base_url();?>assets/img/dp.jpg" />
                                            <div class="message">
                                        ...
                                        <div class="post in">
                                            <img class="avatar" alt="" src="<?php echo base_url();?>assets/img/prof/prof5.jpg" />
                                            <div class="message">
