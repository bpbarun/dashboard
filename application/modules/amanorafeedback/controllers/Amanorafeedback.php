 ...
 * @version         1.0.0
 */
class AmanoraFeedback extends MX_Controller {
    ...
    public function exportAjax() {
        if ($this->checkAuth()) {
            $inputClm = array(
                ...
                4 => 'Email Id',
                5 => 'Your Birth Date',
                6 => 'Your Anniversary Date',
                7 => 'Age',
                8 => 'How did you come to know about AMANORA Mall',
                9 => 'Your reason to visit the mall',
                10 => 'Which Newspaper do you read',
                11 => 'How long did you spend at our Mall',
                12 => 'Parking Experience',
                13 => 'Washroom  Experience',
                14 => 'Which brand you would like to see at Amanora Mall',
                15 => 'Any suggestion to improve your experience',
                16 => 'Rate the overall experience during your visit'
            );
            $data = $this->datatableserverside->TableData($_POST, 'amanora_feedback', $inputClm);
        }
    }
...
//            $data['feedbackHeaderData'] = $this->mFeedback->getFeedbackHeaderData();
    ...
    public function allFeedback() {
        if ($this->checkAuth()) {
            ...
            $data['feedbackQues'] = $this->mFeedback->getAllFeedbackQues();
            $this->load->view('common/header');
            $this->load->view('common/navigation');
